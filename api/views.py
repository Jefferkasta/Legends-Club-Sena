...
class ArtistApi(APIView):
    ...
    def get(self, request):
        ...
        data = Artist.objects.select_related('idUser').values('id','idUser__identificationUser','idUser__firstnameUser','idUser__lastnameUser', 'experienceArtist', 'nationalityArtist', 'stileTattoArtist', 'idUser__phoneUser')
        # data = {'message': 'This is a GET request'}
        return Response(data, status=status.HTTP_200_OK)
